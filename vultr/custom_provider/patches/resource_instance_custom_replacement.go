// I've had to modify this file to add support for reserved_ip
// Link to original license https://github.com/squat/terraform-provider-vultr/blob/master/LICENSE
// This file has to replace https://github.com/JamesClonk/vultr/blob/master/lib/servers.go,
// And works as of July 10, latest commit 45817419b5697ceedfdb57dac30bb3bac57904ff
...
func resourceInstanceCreate(d *schema.ResourceData, meta interface{}) error {
	...
	options := &lib.ServerOptions{
		...
		ReservedIP:           d.Get("reserved_ip").(string),
